...
pub const STACK_GRAPHS_BUILTINS_PATH: &str = "src/builtins.spicy";
/// The stack graphs builtins source for this language.
pub const STACK_GRAPHS_BUILTINS_SOURCE: &str = include_str!("../src/builtins.spicy");
...
pub fn try_language_configuration(
    ...
    LanguageConfiguration::from_sources(
        tree_sitter_spicy::language_spicy(),
        Some(String::from("source.spicy")),
        None,
        vec![String::from("spicy")],
